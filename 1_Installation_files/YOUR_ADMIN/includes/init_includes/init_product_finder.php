...
$module_constant = 'PRODUCT_FINDER_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/product_finder';
$module_name = "Product Finder"; 
$zencart_com_plugin_id = 1141;
...
if ($zencart_com_plugin_id != 0 && !empty($module_file_for_version_check) && $_SERVER["PHP_SELF"] == $module_file_for_version_check) {
