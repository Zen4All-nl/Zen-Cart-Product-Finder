...
//current page is inside PF cats and dd1 AND dd2 are different/have been changed from the current page 
    ...
    <ul>
      ...
      <li class="pf_go">
        <noscript>
        <?php echo zen_image_submit(PF_NOSCRIPT_SUBMIT, PF_NOSCRIPT_SUBMIT_ALT); ?>
        </noscript>
      </li>
      <li>
          <?php
      ...
      <li>
        ...
        ?>
        <?php echo zen_draw_pull_down_menu('cPath', $pf_dd3_array, $pf_dd3_selected, 'id="cPath" class="pf_selectbox_text"'); ?>
        <?php echo zen_draw_hidden_field('pf_base_category', $pf_base_category, 'id="pf_base_category" '); //to pass to js ?>
      </li>
      <li class="pf_go">
        <noscript>
        <?php echo zen_image_submit(PF_NOSCRIPT_SUBMIT, PF_NOSCRIPT_SUBMIT_ALT); ?>
